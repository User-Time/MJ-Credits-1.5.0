...
class ReactionContent extends XFCP_ReactionContent
{
    protected function _postSave()
    {
        if($this->isInsert())
        {
            ...
            if($this->content_type == 'post'){
                $extraData = [
                    'reaction_user_id'    => $this->reaction_user_id,
                    'content_user_id' => $this->content_user_id,
                    'content_type'    => $this->content_type,
                    'content_id'      => $this->content_id,
                    'node_id'         => $this->Content->Thread->node_id,
                ];
                $trigger->triggerEvent('post_like', $this->reaction_user_id, [
                    'content_type' => $this->content_type,
                    'content_id'   => $this->content_id,
                    'node_id'      => $this->Content->Thread->node_id,
                ...
                $trigger->triggerEvent('profile_post_like', $this->reaction_user_id, [
                    'content_type' => $this->content_type,
                    'content_id'   => $this->content_id,
                    'extra_data'   => $extraData
                ]);
    ...
    protected function _postDelete()
    {
        ...
        if($this->content_type == 'post'){
            ...
            $trigger->triggerEvent('post_unlike', $this->reaction_user_id, [
                'content_type' => $this->content_type,
                'content_id'   => $this->content_id,
                'node_id'      => $this->Content->Thread->node_id,
                'extra_data'   => $extraData
        ...
        else if($this->content_type == 'profile_post')
        {
            ...
            $trigger->triggerEvent('profile_post_unlike', $this->reaction_user_id, [
                'content_type' => $this->content_type,
                'content_id' => $this->content_id,
                'extra_data' => $extraData
            ]);
